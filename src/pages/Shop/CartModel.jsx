...
const CartModel = ({ products, isOpen, onClose }) => {
    ...
    return (
        ...
        >
            <div className={`fixed right-0 top-0 md:w-1/3 w-full bg-white h-full overflow-y-auto dark:bg-[#1a202c] dark:text-white transition-transform
                                        ...
                                        <div key={index} className='flex flex-col md:flex-row md:items-center md:justify-between shadow-md md:p-5 p-2 mb-4'>
                                            <div className='flex items-center'>
                                                ...
                                                <div className='flex flex-row md:justify-start justify-end items-center mt-2'>
                                                    ...
                                                    <span className='px-2 items-center mx-1'>{item.quantity}</span>
