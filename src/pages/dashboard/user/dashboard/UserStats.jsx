    ...
    return (
        <div className='my-5 space-y-4  dark:text-white'>
            <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-3 grid-cols-1'>
                <div className='bg-white dark:bg-[#1a202c] shadow-md rounded-lg p-6 border border-gray-200 hover:border-primary cursor-pointer hover:scale-105 transition-all duration-200'>
